...
const Header = () => {
    ...
    return(
        <>
        <div className={`flex font-inter justify-between lg:justify-evenly items-center w-full lg:max-w-[1140px]  h-[77px] px-4 lg:px-3 py-1 bg-[#FFF]`}>
            ...
            text-center rounded-full w-[148.57px] h-[51.19px] text-[20.95px] leading-[25.36px] font-[600]" >Sign up</a>
            {!showMbMenu 
            && 
