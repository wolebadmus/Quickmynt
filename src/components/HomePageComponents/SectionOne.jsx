...
const SectionOne = () => {
  ...
  // md:h-[69.8125em]
  return (
    <section className={"tiny:mt-[10vh] tiny:p-[0] xl:!bg-no-repeat tiny:min-h-[90dvh] tiny:relative  mt-[0] md:mt-[10vh] !bg-cover bg-center banner flex flex-col w-full  md:min-h-[85vh] pt-[2.8em] bg-right  md:bg-top !relative justify-center items-center gap-6 xl:![background-position-x:-0rem] md:![background-position-x:-19rem] md:!relative tiny:!mt-10vh xl:!mt-[15vh] tiny:!h-[90dvh] md:!h-[85vh]"}>
