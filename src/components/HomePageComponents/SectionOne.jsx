...
const SectionOne = () => {
  ...
  // md:h-[69.8125em]
  return (
    <section className={"tiny:mt-[10vh] tiny:p-[0] xl:![background-repeat:round;] tiny:min-h-[90dvh] tiny:relative  mt-[0] md:mt-[10vh] !bg-cover bg-center banner flex flex-col w-full  md:min-h-[85vh] pt-[2.8em] bg-right  md:bg-top !relative justify-center items-center gap-6 !bg-[length:103rem] xl:![background-position-x:-0rem] md:![background-position-x:-19rem] md:!relative tiny:!mt-10vh xl:!mt-[15vh] tiny:!h-[90dvh] md:!h-[85vh]"}>
      ...
      <div className="md:flex md:justify-center md:relative !relative tiny:!absolute md:top-[0] md:left-[0] tiny:bottom-[4rem] flex flex-col justify-start gap-6 md:gap-5 md:w-full md:max-w-[90em] h-[22.249em] md:h-[100%]">
        <div className="md:relative md:top-[-9rem] lg:top-[0] md:ml-[3rem] pt-15 z-40 flex flex-col justify-center gap-4 md:gap-6 max-w-[20.9375em] md:max-w-[33.563em]  ">
          ...
          <p className="text-[#FDFDFD]  max-w-[20.9375em] md:max-w-[20.563em] xl:max-w-[max-content] text-[1em] md:text-[1.5em] font-osande md:font-[200] leading-[24px] md:leading-[35px] text-center md:text-left xl:max-w-[max-content] xl:w-[auto] xl:!min-w-[max-content] xl:leading-tight xl:text-[4vh] tiny:font-[500] md:!font-extralight ">
