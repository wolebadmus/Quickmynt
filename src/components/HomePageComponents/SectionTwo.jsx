...
const SectionTwo = () => {
  ...
  const title_class = " max-w-[20.9375em] lg:max-w-[5.375em] font-[500] lg:font-[600] text-[1.975em] lg:text-[2.5em]  text-[#434343] leading-[34.51px] lg:leading-[46.02px] text-center font-osande";
  const sub_class = " max-w-[21.9375em] lg:max-w-[18.875em] font-[500] text-[1em] lg:text-[1.125em] text-[#9D9D9D] leading-[24px] lg:leading-[28px] text-center font-graphik";

  return (
    <section className="mt-[3rem] max-w-[23.1875em] w-full lg:max-w-[90em] py-16 flex flex-col justify-center items-center gap-16 ">
      <p
        className="max-w-[9.3125em] lg:max-w-[9.2em] text-center font-osande font-[700] text-[#161616] lg:font-[600] text-[2.0738em] 
      ...
      <div className="flex flex-col lg:flex-row justify-evenly w-full gap-16">
        ...
        <div className="flex flex-col items-center gap-5">
          ...
          <div className="flex flex-col items-center gap-5">
            <p className={title_class + " lg:max-w-[8em] lg:max-w-[7.375em] "}>Seamless Payroll Deduction</p>
