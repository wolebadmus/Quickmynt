...
const SectionSix = () => {
    ...
    return (
        <section className="stats flex flex-col w-full bg-right-bottom lg:bg-center relative justify-center items-center gap-6  mt-20">
            ...
            <div className="flex flex-col justify-center gap-6 lg:gap-10 lg:w-full lg:max-w-[1140px] text-white py-40">
                <div className="z-40 flex flex-col justify-evenly gap-4 lg:gap-8 w-full">
                    <p className="w-[372px] lg:w-[643px] font-osande font-[700] lg:font-[600] text-[30px] lg:text-[60px] leading-[40px] lg:leading-[65px] text-center lg:text-left ">
                        It's Clear: A Platform Such as QuickMynt is What Employees Want
                    </p>
                    <p className="w-[372px] lg:w-[643px] font-graphik font-[400] lg:font-[500] text-[18px] lg:text-[24px] leading-[26px] lg:leading-[35px] text-center lg:text-left">
