...
const mbNavBar = ({showMbMenu, setShowMbMenu}) => {
    ...
    return (
        <nav className={`lg:hidden flex flex-col justify-start gap-8  px-4 py-3 absolute z-50 bg-white top-0 w-full transition-all duration-300 ${showMbMenu ? "h-full max-h-[35.766em]" : "max-h-0 !py-0"}   overflow-hidden`}>
