    ...
    return (
        <section className={"banner flex flex-col w-full h-[42em]  lg:min-h-[100vh] pt-[2.8em] bg-right-bottom lg:bg-top relative justify-center items-center gap-6"}>
            ...
            <div className="flex flex-col justify-center gap-6 lg:gap-5 lg:w-full lg:max-w-[71.25em] h-[18.075em] lg:h-[39.824em]">
                ...
                <button className="z-40 text-base text-[#F3FEF6] font-graphik font-[500] text-[1.0112em] lg:text-[1.094em] leading-[17.8px] lg:leading-[23.05px] bg-[#488559] w-[11.6669em]
                 lg:w-[10.5981em] h-[2.3887em] lg:h-[3.0744em] hover:text-[#488559] hover:bg-[#FFF] hover:border hover:border-[#488559] rounded-full z-40 mx-auto lg:mx-0">
                    Request a Demo
                </button>
            </div>
        </section>
