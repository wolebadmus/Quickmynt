...
const SectionTwo = () => {
    ...
    const img_class = "w-[11.855em] h-[15.0987em] lg:w-[14.875em] lg:h-[10.3125em] obj-contain";
    const title_class = "max-w-[20.9375em] lg:max-w-[7.375em]  font-[600] text-[1.575em] lg:text-[2em]  text-[#434343] leading-[34.51px] lg:leading-[46.02px] text-center font-osande";
    ...
    return (
        <section className="max-w-[23.1875em] w-full lg:max-w-[71.25em] py-5 flex flex-col justify-center items-center gap-16 ">

            <p className="max-w-[9.3125em] lg:max-w-[8.5em] text-center font-osande font-[700] text-[#161616] lg:font-[600] text-[2.0738em] lg:text-[3em] leading-[38.17px] lg:leading-[61.32px]">
