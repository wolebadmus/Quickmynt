...
const SectionEight = () => {
    ...
    return (
        ...
        <div className="flex flex-col justify-center items-center max-w-[23.18em] lg:w-full lg:max-w-[71.25em] gap-8">
            <p className="max-w-[23.18em] w-full lg:max-w-[55.69em] font-osande lg:font-graphik font-[700] lg:font-[500] text-[1.88em] lg:text-[3em] leading-[40px] lg:leading-[52.8px] text-center">
        ...
        <div className="flex flex-col lg:flex-row mt-10 gap-10 lg:gap-0 max-w-[23.18em] w-full lg:max-w-[71.25em]">
