                ...
                <div className="flex w-full px-[1em] lg:max-w-[76.188em] lg:items-center justify-between">
                    <form action="" method="post" className="w-full max-w-[20.625em] flex flex-col gap-8">
                        <div className=" w-full flex flex-col gap-3">
                            ...
                            <input type="text" name="fname" id="" className="bg-[#EDEDED] px-2 text-[#434343]  w-full h-[2.75em] rounded-xl" 
                        ...
                        <div className=" w-full flex flex-col gap-3">
                            ...
                            className="-mt-1" color="#F8B84E" /></label>
                            <input type="text" name="lname" id="" className="bg-[#EDEDED] px-2 text-[#434343]  w-full h-[2.75em] rounded-xl" 
                        ...
                        <div className=" w-full flex flex-col gap-3">
                            ...
                            className="-mt-1" color="#F8B84E" /></label>
                            <input type="text" name="compEmail" id="" className="bg-[#EDEDED] px-2 text-[#434343]  w-full h-[2.75em] rounded-xl" 
                            value={formData.compEmail} onChange={handleChange} />
                        </div>
                        <div className=" w-full flex flex-col gap-3">
                            ...
                            className="-mt-1" color="#F8B84E" /></label>
                            <input type="text" name="compName" id="" className="bg-[#EDEDED] px-2 text-[#434343]  w-full h-[2.75em] rounded-xl" 
                            value={formData.compName} onChange={handleChange} />
                        </div>
                        <div className=" w-full flex flex-col gap-3">
                            ...
                            className="-mt-1" color="#F8B84E" /></label>
                            <input type="text" name="pnum" id="" className="bg-[#EDEDED] px-2 text-[#434343]  w-full h-[2.75em] rounded-xl" 
                            value={formData.pnum} onChange={handleChange} />
                        </div>
                        <div className=" w-full flex flex-col gap-3">
                            ...
                            className="-mt-1" color="#F8B84E" /></label>
                            <input type="text" name="employees_num" id="" className="bg-[#EDEDED] px-2 text-[#434343]  w-full h-[2.75em] rounded-xl" 
                            value={formData.employees_num} onChange={handleChange} />
                        </div>
                        <div className=" w-full flex flex-col gap-3">
                            <label htmlFor="fname" className="flex font-graphik font-[500] text-[1.125em] lg:text-[1.25em] gap-1">How can we help?</label>
                            <textarea name="customer_message" id="" className="bg-[#EDEDED] px-2 text-[#434343] pt-3  w-full h-[12.375em] rounded-xl" 
                            value={formData.customer_message} onChange={handleChange} />
                        </div>
                        ...
                        {!loading ?
                        <button onClick={handleSubmit} className="z-40 text-[#F3FEF6] font-graphik font-[500] text-[1.0112em] lg:text-[1.094em] leading-[17.8px] lg:leading-[23.05px]
