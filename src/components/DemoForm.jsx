...
const DemoForm = () => {
    ...
    return (
        <div className={`z-[100] lg:z-[40] lg:w-full lg:max-w-[85em] fixed bg-white top-0 inset-0 lg:top-40 shadow-2xl left-0 right-0 flex-col  items-center pb-6 lg:pb-20 px-3 lg:px-0
         ${isOpen ? "flex" : "hidden"} overflow-y-auto overflow-x-hidden lg:overflow-y-hidden transition-all duration-500 `}>
